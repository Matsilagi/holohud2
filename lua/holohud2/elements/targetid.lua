...
local ELEMENT = {
    ...
    parameters  = {
        ...
        healthbar_size          = { name = "#holohud2.parameter.size", type = HOLOHUD2.PARAM_VECTOR, value = { x = 72, y = 6 } },
        ...
        suitbar_size            = { name = "#holohud2.parameter.size", type = HOLOHUD2.PARAM_VECTOR, value = { x = 72, y = 6 } },
